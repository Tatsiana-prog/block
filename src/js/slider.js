...
function init(delayTime) {
  ...
  ospin.style.width = Math.min(maxWidth, imgWidth) + "px"; // Устанавливаем ширину слайдера
}
...
function applyTranform(obj) {
  if (tY > 180) tY = 180;
  if (tY < 0) tY = 0;
  tX = Math.min(maxWidth, Math.max(-maxWidth, tX)); // Ограничиваем ширину до maxWidth
